// To parse this data:
//
//   import { Convert, SerchResponse } from "./file";
//
//   const serchResponse = Convert.toSerchResponse(json);
//
...
export class Convert {
    public static toSerchResponse(json: string): SerchResponse {
        return cast(JSON.parse(json), r("SerchResponse"));
    }

    public static serchResponseToJson(value: SerchResponse): string {
        return JSON.stringify(uncast(value, r("SerchResponse")), null, 2);
    }
}
